...
import demo.blibli.com.project01.retrovit.MovieService;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieRecycleView = findViewById(R.id.recycle_view_movie);
        movieLayoutManager = new LinearLayoutManager(this);
        movieLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL); // ini tu ngebikin data nya jalan secara
        //horizontal
        ...
        movieService.findPopularMovies("4bbbfeaa56287e045385e892563e7168")
                .enqueue(new Callback<ListResponse<MovieResponse>>() {
                    ...
                    @Override
                    public void onFailure(Call<ListResponse<MovieResponse>> call,
                                          Throwable t) {
                        Log.e("asd",t.getMessage(), t);
                        Toast.makeText(HomeActivity.this,"HTTP EROR BOSQUE", Toast.LENGTH_SHORT).show();
                    }
                }
        );
